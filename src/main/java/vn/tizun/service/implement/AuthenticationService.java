...
public class  AuthenticationService implements IAuthenticationService {
    ...
    public TokenResponse getAccessToken(SignInRequest request) {
        ...
        String accessToken = jwtService.generateAccessToken(user.getId(), request.getUsername(), authorities);
        String refreshToken = jwtService.generateRefreshToken(user.getId(), request.getUsername(), authorities);
